...
//self properties -JNE
	...
	native String hudName(); //Returns the Name on the HUD -JRA
	native String hudScore(); //Returns the Score on the HUD -JRA
	native double hudTimeLeft(); //Returns the Time Left on the HUD -JRA
...
//idx functions, idx is the index in the sorted ship buffer-JNE
	...
	native int wallFeeler(int dist, int angle, int flag_wf, int flag_wd); //Returns if there is a wall or not at the Specified Angle within the Specified Distance of the ship -JRA
	native int wallFeelerRad(int dist, double a, int flag_wf, int flag_wd); //Returns if there is a wall or not at the Specified Angle within the Specified Distance of the ship -JRA
