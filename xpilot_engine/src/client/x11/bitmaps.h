...
#define BM_QUAD 45
#define BM_QUAD_FRIEND 46
#define BM_QUAD_ENEMY 47
#define BM_FIXED 48
#define BM_FIXED_FRIEND 49
#define BM_FIXED_ENEMY 50
#define BM_TANK 51
#define BM_TANK_FRIEND 52
#define BM_TANK_ENEMY 53
#define BM_INFANTRY 54
#define BM_INFANTRY_FRIEND 55
#define BM_INFANTRY_ENEMY 56
#define BM_BULLET_RED 57
#define BM_BASE_ENEMY 58

#define BM_BEE 59
#define BM_BEE_FRIEND 60
#define BM_BEE_ENEMY 61

#define BM_BEE_FORAGER 62
#define BM_BEE_SEARCHER 63
#define BM_BEE_NURSE 64
#define BM_BEE_ONLOOKER 65
#define BM_BEE_GUARD 66
#define BM_BEE_ATTACKER 67

#define BM_BEE_ENEMY_FORAGER 68
#define BM_BEE_ENEMY_SEARCHER 69
#define BM_BEE_ENEMY_NURSE 70
#define BM_BEE_ENEMY_ONLOOKER 71
#define BM_BEE_ENEMY_GUARD 72
#define BM_BEE_ENEMY_ATTACKER 73

#define BM_BEE_FRIEND_FORAGER 74
#define BM_BEE_FRIEND_SEARCHER 75
#define BM_BEE_FRIEND_NURSE 76
#define BM_BEE_FRIEND_ONLOOKER 77
#define BM_BEE_FRIEND_GUARD 78
#define BM_BEE_FRIEND_ATTACKER 79

#define BM_OBSERVER 80

#define NUM_OBJECT_BITMAPS 81
#define NUM_BITMAPS	81
