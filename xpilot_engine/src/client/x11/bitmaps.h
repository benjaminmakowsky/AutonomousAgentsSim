...
#define BM_BEE_ENEMY_FORAGER 65
#define BM_BEE_ENEMY_SEARCHER 66
#define BM_BEE_ENEMY_NURSE 67

#define BM_BEE_FRIEND_FORAGER 68
#define BM_BEE_FRIEND_SEARCHER 69
#define BM_BEE_FRIEND_NURSE 70

#define NUM_OBJECT_BITMAPS 71
#define NUM_BITMAPS	71
