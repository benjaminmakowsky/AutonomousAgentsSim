...
typedef struct player {
	...
	objpoint_t objpoint;   /* Where the objective is located */
	clpos_t fuelpoint;  /* Where the fuel station is located */
	int numInRole;        /* How many units share this role */
	int numInShape;       /* How many units share this shape */
