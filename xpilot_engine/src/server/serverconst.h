...
#define STATION_REGENERATION	0.50
...
#define SHIP_SPAWN_CMD "gnome-terminal -- sh -c 'cd ../../../xpilot_ai/c/ && export LD_LIBRARY_PATH=. && ./bee %d %d %d %d -team %d -join -name newBorn%d -shipShape %s -headlessMode true '"
