#! /bin/bash
#clientPath="/Downloads/xpilot-ng-4.7.3/src/client/x11/"
clientPath="../../src/client/x11/"

rm -f libcAI.so
cp cAI.h $clientPath
cd $clientPath
sudo gcc -w -fPIC -Wl,-wrap,Handle_end -DHAVE_CONFIG_H -I. -I../../..  -DCONF_DATADIR=\"../../../share/xpilot-ng/\" -I../../../src/common -I../../../src/client -g -O2 -MT cAI.o -MD -MP -MF .deps/cAI.Tpo -c -o cAI.o cAI.c
...
rm cAI.h
cd ../../../xpilot-ng-temp/c/
gcc defender.c libcAI.so -lpthread -lm -o defender 
