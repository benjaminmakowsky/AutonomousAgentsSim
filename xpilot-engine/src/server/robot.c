...
// Current set-up:
// 4 fixed-wings to recon the perimeter
// 4 quad-copters, each aiding a fixed wing
// 4 tanks, part of response force
// 4 infantry, part of response force
static robot_t DefaultRobots[] = {
 ...
 "AI_scout_1",
  "80 20",
  0,
   "(SH: 8,2 7,4 -2,15 -7,15 -2,11 0,5 0,2 0,0 0,-5 -3,-12 "
   "-7,-15 -2,-15 7,-4 8,-2 9,-1 10,-1 11,0 10,1 9,1)(EN: 1,0)(MG: 9,0)(NM:fixed)" 
    },
  {
  DEFAULT_ROBOT_TYPE,
  "AI_scout_2",
  ...
  "1 99",
  0,
 "(SH: -4,7 -2,9 0,11 2,9 4,7 6,6 11,9 11,10 8,13 8,14 11,11 12,11 "
 "13,10 13,9 15,6 15,5 12,9 7,5 7,3 7,-5 11,-9 12,-8 15,-5 15,-6 11,-10 "
 "11,-11 9,-12 8,-12 5,-15 4,-15 9,-10 9,-9 6,-5 5,-6 3,-7 -3,-7 -5,-6 -6,-5 "
 "-9,-9 -9,-10 -4,-15 -5,-15 -10,-10 -11,-10 -12,-9 -12,-8 -15,-5 -14,-5 -11,-8 "
 "-10,-8 -7,-5 -7,5 -12,9 -14,4 -15,3 -13,9 -13,10 -12,12 -11,12 -9,15 -9,14 -11,10"
 "-6,6 -4,7)(EN: 0,-5)(MG: 0,9)(NM:quad)"
   },
  {
  DEFAULT_ROBOT_TYPE,
  "AI_quad_fighter_2",
  "1 99",
  0,
 "(SH: -4,7 -2,9 0,11 2,9 4,7 6,6 11,9 11,10 8,13 8,14 11,11 12,11 13,10 13,9 15,6 15,5 12,9 7,5 7,3 7,-5 11,-9 12,-8 15,-5 15,-6 11,-10 11,-11 9,-12 8,-12 5,-15 4,-15 9,-10 9,-9 6,-5 5,-6 3,-7 -3,-7 -5,-6 -6,-5 -9,-9 -9,-10 -4,-15 -5,-15 -10,-10 -11,-10 -12,-9 -12,-8 -15,-5 -14,-5 -11,-8 -10,-8 -7,-5 -7,5 -12,9 -14,4 -15,3 -13,9 -13,10 -12,12 -11,12 -9,15 -9,14 -11,10 -6,6 -4,7)(EN: 0,-5)(MG: 0,9)(NM:quad)"
   },
  {
  DEFAULT_ROBOT_TYPE,
  "AI_quad_fighter_3",
 ...
 "(SH: -4,7 -2,9 0,11 2,9 4,7 6,6 11,9 11,10 8,13 8,14 11,11 12,11 13,10 13,9 15,6 15,5 12,9 7,5 7,3 7,-5 11,-9 12,-8 15,-5 15,-6 11,-10 11,-11 9,-12 8,-12 5,-15 4,-15 9,-10 9,-9 6,-5 5,-6 3,-7 -3,-7 -5,-6 -6,-5 -9,-9 -9,-10 -4,-15 -5,-15 -10,-10 -11,-10 -12,-9 -12,-8 -15,-5 -14,-5 -11,-8 -10,-8 -7,-5 -7,5 -12,9 -14,4 -15,3 -13,9 -13,10 -12,12 -11,12 -9,15 -9,14 -11,10 -6,6 -4,7)(EN: 0,-5)(MG: 0,9)(NM:quad)"
  ...
  "1 99",
  0,
  "(SH: 0,3 0,-2 -1,-4 -3,-5 -2,-6 -2,-7 -3,-8 -6,-8 -7,-7 -7,-6 -6,-5 -3,-5 -6,-5 -8,-4 -8,3 -6,4 -7,5 -7,6 -6,7 -5,8 -3,8 -2,7 -2,5 -3,4 -6,4 -3,4 -1,4 0,3 0,-1 8,-1 8,-2 2,-2 2,-3 -1,-3 0,-2)(EN: -7,0)(MG: 1,-2)(NM:infantry)"
   },
  {
  DEFAULT_ROBOT_TYPE,
  "AI_infantry_2",
  ...
  "1 99",
  0,
  "(SH: -8,6 8,6 8,8 -8,8 -8,-8 8,-8 8,-6 -8,-6 -8,-4 6,-4 6,4 -8,4 -6,4 -6,-4 6,-4 6,-1 15,-1 15,1 6,1 6,4 -8,4)(EN: -6,0)(MG: 7,0)(NM:drone_tank)"
   },
  {
  DEFAULT_ROBOT_TYPE,
  "AI_tank_2",
...
static int idxReaction;
static int idxDefend;
static int idxQuad;
static int idxFixed;
static int idxTank;
static int idxInfantry;
...
static void Robot_create(void)
{
    ...
    shipshape_t* parsed_shape = Parse_shape_str(rob->shape);
    Init_player(NumPlayers,
		options.allowShipShapes ? parsed_shape : NULL,
		PL_TYPE_ROBOT);
    ...
    //Stats are based on shipshape
    if( !strcmp( parsed_shape->name, "quad" ) ){
      robot->power = 45.0;
      robot->armor = 2;
      robot->maxturnsps = 255;
      robot->shots = 2;
      robot->sight_range = 4;
      robot->mass = 5;
      robot->emptymass = 5;
      robot->fuel.max = 200;
      robot->turnspeed = 50;
      robot->idxInRole = idxDefend++;
      robot->idxInShape = idxQuad++;
      strncpy( robot->shapename, "quad", sizeof("quad") );
      strncpy( robot->role, "stationary_defend", sizeof("stationary_defend") );
    }
    else if( !strcmp( parsed_shape->name, "fixed" ) ){
      robot->power = 70.0;
      robot->armor = 1;
      robot->maxturnsps = 180;
      robot->shots = 1;
      robot->sight_range = 7;
      robot->mass = 5;
      robot->emptymass = 5;
      ...
      robot->idxInRole = idxDefend++;
      robot->idxInShape = idxQuad++;
      strncpy( robot->shapename, "fixed", sizeof("fixed") );
      strncpy( robot->role, "stationary_defend", sizeof("stationary_defend") );
    }
    else if( !strcmp( parsed_shape->name, "drone_tank" ) ){
      robot->power = 25.0;
      robot->armor = 2;
      robot->maxturnsps = 100;
      robot->shots = 5;
      robot->sight_range = 2;
      robot->mass = 5;
      robot->emptymass = 5;
      robot->fuel.max = 1000;
      robot->turnspeed = 25;
      strncpy( robot->shapename, "drone_tank", sizeof("drone_tank") );
      strncpy( robot->role, "reaction_force", sizeof("reaction_force") );
    }
    else if( !strcmp( parsed_shape->name, "infantry" ) ){
      robot->power = 35.0;
      robot->armor = 2;
      robot->maxturnsps = 255;
      robot->shots = 3;
      ...
      robot->fuel.max = 9999;
      robot->turnspeed = 50;
      strncpy( robot->shapename, "infantry", sizeof("infantry") );
      strncpy( robot->role, "reaction_force", sizeof("reaction_force") );
    }
    else{
      robot->power = MAX_PLAYER_POWER;
      robot->armor = 1;
      robot->maxturnsps = MAX_SERVER_FPS;
      robot->shots = 2;
      robot->sight_range = 3;
      robot->mass = 5;
      robot->emptymass = 5;
      ...
      strncpy( robot->shapename, "default", sizeof("defautl") );
      strncpy( robot->role, "default", sizeof("default") );
    }
    robot->turnresistance = 0.12;
    robot->turnresistance_s = 0.12;
    robot->check = 0;
    
    //TODO: Have the input parameters set this
    objpoint_t obj;
    obj.pos.cx = -100;
    obj.pos.cy = 100;
    robot->objpoint = obj;
    ...
    //Set their initial rally point (formation) here
    Set_rallypoint(robot);
