...
cp cAI.h $clientPath
cd $clientPath
gcc -w -fPIC -Wl,-wrap,Handle_end -DHAVE_CONFIG_H -I. -I../../..  -DCONF_DATADIR=\"../../../share/xpilot-ng/\" -I../../../src/common -I../../../src/client -g -O2 -MT cAI.o -MD -MP -MF .deps/cAI.Tpo -c -o guiobjects.o guiobjects.c
...
rm cAI.h
cd ../../../../xpilot_ai/c/
gcc -g chaser.c libcAI.so -lpthread -lm -o chaser
