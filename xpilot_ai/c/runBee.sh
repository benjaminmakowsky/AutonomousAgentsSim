...
./bee 0 1 11 $teamnum -team $teamnum -join -name b1 -shipShape fixed &
sleep 3
./bee 0 2 11 $teamnum -team $teamnum -join -name b2 -shipShape fixed &
sleep 3
./bee 0 3 11 $teamnum -team $teamnum -join -name b3 -shipShape fixed &
#sleep 1
