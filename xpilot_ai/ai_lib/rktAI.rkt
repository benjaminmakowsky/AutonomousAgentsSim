...
(module rktAI racket/base
  ...
  (define hudName; Returns the Name on the HUD -JRA
    (get-ffi-obj "hudName" ai (_fun -> _string)))
  (define hudScore; Returns the Score on the HUD -JRA
    (get-ffi-obj "hudScore" ai (_fun -> _string)))
  (define hudTimeLeft; Returns the Time Left on the HUD -JRA
    (get-ffi-obj "hudTimeLeft" ai (_fun -> _double)))
  ...
  (define wallFeeler; Returns if there is a wall or not at the Specified Angle within the Specified Distance of the ship -JRA
    (get-ffi-obj "wallFeeler" ai (_fun _int _int _int _int -> _int)))
  (define wallFeelerRad; Returns if there is a wall or not at the Specified Angle within the Specified Distance of the ship -JRA
    (get-ffi-obj "wallFeelerRad" ai (_fun _int _double _int _int -> _int)))
  (define wallBetween; Returns if there is a wall or not between two Specified Points -JRA
    (get-ffi-obj "wallBetween" ai (_fun _int _int _int _int _int _int -> _int)))
  ; Shot functions -JNE
